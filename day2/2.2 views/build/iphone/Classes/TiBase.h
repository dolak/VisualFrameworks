...
// in simulator we redefine to format for k22views Developer console
...
{\
	NSString * exceptionName = [@"org.k22views." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k22views";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk22viewsNativeItemNone = -1, 
	UIk22viewsNativeItemSpinner = -2,
	UIk22viewsNativeItemProgressBar = -3,
	
	UIk22viewsNativeItemSlider = -4,
	UIk22viewsNativeItemSwitch = -5,
	UIk22viewsNativeItemMultiButton = -6,
	UIk22viewsNativeItemSegmented = -7,
	
	UIk22viewsNativeItemTextView = -8,
	UIk22viewsNativeItemTextField = -9,
	UIk22viewsNativeItemSearchBar = -10,
	
	UIk22viewsNativeItemPicker = -11,
	UIk22viewsNativeItemDatePicker = -12,
	
	UIk22viewsNativeItemInfoLight = -13,
	UIk22viewsNativeItemInfoDark = -14,
	
	UIk22viewsNativeItemDisclosure = -15,
	
	UIk22viewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k22views instances of
