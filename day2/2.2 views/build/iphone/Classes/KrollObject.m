...
//@interface k22viewsObject : NSObject
//@end

@interface k22viewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k22viewsObject class]])
		{
			for (NSString *key in [[(k22viewsObject*)o modules] allKeys])
			{
