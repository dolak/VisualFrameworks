...
//@interface k21windowsObject : NSObject
//@end

@interface k21windowsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k21windowsObject class]])
		{
			for (NSString *key in [[(k21windowsObject*)o modules] allKeys])
			{
