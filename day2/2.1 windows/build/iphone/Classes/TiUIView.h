...
/**
 Base class for all k21windows views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k21windows view hierarchy (such as wrapped iOS UIViews) was touched.
