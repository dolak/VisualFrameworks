...
@interface k21windowsObject : KrollCoverageObject {
#else
@interface k21windowsObject : KrollObject {
#endif
@private
...
extern NSString * k21windows$ModuleRequireFormat;
