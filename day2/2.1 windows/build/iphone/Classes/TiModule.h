...
/**
 The base class for all k21windows modules
 */
...
/**
 k21windows Platform calls this method on startup.
 */
-(void)startup;

/**
 k21windows Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k21windows Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k21windows Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k21windows Platform calls this method on resume.
 @param sender The sender of the event.
 */
