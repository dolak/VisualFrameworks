...
// in simulator we redefine to format for k21windows Developer console
...
{\
	NSString * exceptionName = [@"org.k21windows." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k21windows";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk21windowsNativeItemNone = -1, 
	UIk21windowsNativeItemSpinner = -2,
	UIk21windowsNativeItemProgressBar = -3,
	
	UIk21windowsNativeItemSlider = -4,
	UIk21windowsNativeItemSwitch = -5,
	UIk21windowsNativeItemMultiButton = -6,
	UIk21windowsNativeItemSegmented = -7,
	
	UIk21windowsNativeItemTextView = -8,
	UIk21windowsNativeItemTextField = -9,
	UIk21windowsNativeItemSearchBar = -10,
	
	UIk21windowsNativeItemPicker = -11,
	UIk21windowsNativeItemDatePicker = -12,
	
	UIk21windowsNativeItemInfoLight = -13,
	UIk21windowsNativeItemInfoDark = -14,
	
	UIk21windowsNativeItemDisclosure = -15,
	
	UIk21windowsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k21windows instances of
