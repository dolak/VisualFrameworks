...
//@interface k23LabelsObject : NSObject
//@end

@interface k23LabelsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k23LabelsObject class]])
		{
			for (NSString *key in [[(k23LabelsObject*)o modules] allKeys])
			{
