...
@interface k23LabelsObject : KrollCoverageObject {
#else
@interface k23LabelsObject : KrollObject {
#endif
@private
...
extern NSString * k23Labels$ModuleRequireFormat;
