...
// in simulator we redefine to format for k23Labels Developer console
...
{\
	NSString * exceptionName = [@"org.k23labels." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k23labels";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk23LabelsNativeItemNone = -1, 
	UIk23LabelsNativeItemSpinner = -2,
	UIk23LabelsNativeItemProgressBar = -3,
	
	UIk23LabelsNativeItemSlider = -4,
	UIk23LabelsNativeItemSwitch = -5,
	UIk23LabelsNativeItemMultiButton = -6,
	UIk23LabelsNativeItemSegmented = -7,
	
	UIk23LabelsNativeItemTextView = -8,
	UIk23LabelsNativeItemTextField = -9,
	UIk23LabelsNativeItemSearchBar = -10,
	
	UIk23LabelsNativeItemPicker = -11,
	UIk23LabelsNativeItemDatePicker = -12,
	
	UIk23LabelsNativeItemInfoLight = -13,
	UIk23LabelsNativeItemInfoDark = -14,
	
	UIk23LabelsNativeItemDisclosure = -15,
	
	UIk23LabelsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k23Labels instances of
