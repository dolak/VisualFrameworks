...
/**
 Base class for all k23Labels views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k23Labels view hierarchy (such as wrapped iOS UIViews) was touched.
